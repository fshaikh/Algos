 ...
 *   
 *  Algorithms:
 *     There are a few ways of implementing DisjointSet. 
 ...
 *                     S1 = {1,2,3}  S2 = {4,5}, call union(2,4) and new set will be S3 = {1,2,3,4,5}
 ...
 *                  Done
 * 
 *     The most efficient is "Union By Rank and Path Compression".
 * 
 * Complexity:
 *    Time :
 *    Space: 
...
class DisjointSet {
    ...
    union(element1, element2) {
        ...
        // If both elements have the same parent ( i.e they belong to the same set)
    ...
    initialize() {
        ...
        this._seedRank = -1;
        this._parent = -1;
        // key => representative element, value => array of set elements
