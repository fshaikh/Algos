...
Input: An array arr containing N integers, denoting the numbers in the list.
Output format: An int representing the worst possible total penalty.
...
function getTotalTime(arr) {
    ...
    return penalty;
    //  iterate the array   (N)
    //    add i and i + 1. Add sum to penalty
    //    remove i and i + 1.  
    //    Add new sum  
  }

  console.log(getTotalTime([2, 3, 9, 8, 4])); // 88
  console.log(getTotalTime([4, 2, 1, 3])); // 26